...
if __name__ == "__main__":
    ...
    print("Lee!!!")
    print(args.results_dir, "final_result_L.jpg")
    torchvision.utils.save_image(result_image.detach().cpu(), os.path.join(args.results_dir, "final_result_Lee.jpg"), normalize=True, scale_each=True, range=(-1, 1))
