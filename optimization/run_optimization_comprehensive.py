...
def gru_ebs(args, wav_path):
    ...
    generator_file = '/mnt/ssd/BeautifulXJJ/AIGC/Sound-Image-Generation/Diffusion_gen/Generate-Lyrics-and-Melody-with-Emotions/GRU_generator_seqlen_50_embed_128_epoch_59.pkl'
