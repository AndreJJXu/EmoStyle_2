...
def main(args):
    ...
    if args.latent_path:
        # latent_code_init = Inference(args.latent_path, 'church_encode').cuda()
        # print(args.latent_path)
    ...
    for i in pbar:
        ...
        if flag:
            cosine_distance_loss = soundclip_loss(img_gen, audio_inputs, text_inputs)
        else:
